...
<?php require("analytics.php");?>
  ...
  <body>
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="page-heading">
              <h1>Contato</h1>
              <span class="subheading">Qualquer dúvida, entre em contato</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <p>Tem algo que possams lhe ajudar? Preencha o formulário abaixo</p>
          ...
          <form name="sentMessage" id="contactForm" novalidate>
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls">
                ...
                <textarea rows="5" class="form-control" placeholder="Mensagem" id="message" required data-validation-required-message="Preencha o campo mensagem."></textarea>
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <br>
